...
describe('OK-173 break-glass deployment candidate', () => {
  it('pins the reviewed break-glass image and authentication boundary', async () => {
    ...
    expect(overlay).toContain('sha256:20860b2f87ffd9454c5925aba4fac83dc1c6f4787ec89b935fbcb76fc68600f')
  ...
  it('renders a valid candidate manifest with the immutable image', async () => {
    ...
    expect(stdout).toContain('image: ghcr.io/openkubes/ok-console@sha256:20860b2f87ffd9454c5925aba4fac83dc1c6f4787ec89b935fbcb76fc68600f')
